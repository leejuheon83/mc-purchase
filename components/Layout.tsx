...
const Layout: React.FC<LayoutProps> = ({ user, activeView, onViewChange, onLogout, children }) => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-slate-100 text-slate-900">
      <aside className="w-full md:w-72 bg-slate-50 border-r border-slate-200 flex flex-col z-20">
        <div className="px-6 py-5 border-b border-slate-200 bg-slate-50 flex justify-center md:justify-start overflow-hidden">
          <Logo size="sm" />
        </div>
